...
public class PmsProductAttributeCategoryController {
    ...
    @ResponseBody
    public Object getList(@RequestParam(defaultValue = "5") Long pageSize, @RequestParam(defaultValue = "1") Long pageNum) {
        //TODO 分页获取所有商品属性分类
        PageInfoVo pageInfoVo = productAttributeCategoryService.getAttributeInfo(pageNum, pageSize);
